...
const slot5 = slots[Math.floor(Math.random() * slots.length)];
    ...
    const winnings = calculateWinnings(slot1, slot2, slot3, slot4, slot5, amount);
    ...
    const messageText = getSpinResultMessage(slot1, slot2, slot3, slot4, slot5, winnings, getLang);

    return message.reply(messageText);
  },
};

function calculateWinnings(slot1, slot2, slot3, slot4, slot5, betAmount) {
  if (slot1 === "🍒" && slot2 === "🍒" && slot3 === "🍒" && slot4 === "🍊" && slot5 === "🍊") {
    return betAmount * 10;
  } else if (slot1 === "🍇" && slot2 === "🍇" && slot3 === "🍇" && slot4 === "🍓" && slot5 === "🍓") {
    return betAmount * 5;
  } else if (slot1 === slot2 && slot2 === slot3 && slot3 === slot4 && slot4 === slot5) {
    return betAmount * 3;
  } else if (slot1 === slot2 || slot1 === slot3 || slot2 === slot3 || slot3 === slot4 || slot4 === slot5) {
    return betAmount * 2;
  } else {
    return -betAmount;
  }
...
function getSpinResultMessage(slot1, slot2, slot3, slot4, slot5, winnings, getLang) {
  if (winnings > 0) {
    if (slot1 === "🍒" && slot2 === "🍒" && slot3 === "🍒" && slot4 === "🍊" && slot5 === "🍊") {
